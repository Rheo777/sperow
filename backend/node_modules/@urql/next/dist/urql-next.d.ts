import { AnyVariables, RequestPolicy, OperationContext, GraphQLRequestParams, CombinedError, Operation, SSRExchange, Client } from 'urql';
export * from 'urql';
 ...
 * ```
 */
declare function useQuery<Data = any, Variables extends AnyVariables = AnyVariables>(args: UseQueryArgs<Variables, Data>): UseQueryResponse<Data, Variables | undefined>;

declare const SSRContext: React.Context<SSRExchange | undefined>;
 ...
 * ```
 */
declare function UrqlProvider({ children, ssr, client, nonce, }: React.PropsWithChildren<{
    ssr: SSRExchange;
    client: Client;
    nonce?: string;
}>): React.FunctionComponentElement<React.ProviderProps<object | Client>>;

export { SSRContext, UrqlProvider, useQuery };
