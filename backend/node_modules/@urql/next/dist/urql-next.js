...
var DataHydrationContext = React.createContext(undefined);
...
var DataHydrationContextProvider = ({
  ...
  var dataHydrationContext = React.useRef();
  if (typeof window == 'undefined') {
    if (!dataHydrationContext.current) dataHydrationContext.current = buildContext({
      nonce
    });
  }
  return React.createElement(DataHydrationContext.Provider, {
    value: dataHydrationContext.current
  }, children);
};
function useDataHydrationContext() {
  var dataHydrationContext = React.useContext(DataHydrationContext);
  var insertHtml = React.useContext(navigation.ServerInsertedHTMLContext);
  if (typeof window !== 'undefined') return;
  if (insertHtml && dataHydrationContext && !dataHydrationContext.isInjecting) {
    dataHydrationContext.isInjecting = true;
    insertHtml(() => React.createElement(dataHydrationContext.RehydrateScript, {}));
  }
...
function buildContext({
  ...
  var dataHydrationContext = {
    ...
    RehydrateScript() {
      ...
      if (!Object.keys(dataHydrationContext.operationValuesByKey).length) return React.createElement(React.Fragment);
...
var SSRContext = React.createContext(undefined);
...
function UrqlProvider({
  ...
  return React.createElement(urql.Provider, {
    value: client
  }, React.createElement(SSRContext.Provider, {
    value: ssr
  }, React.createElement(DataHydrationContextProvider, {
    nonce
  }, children)));
}
...
function useUrqlValue(operationKey) {
  var ssrExchange = React.useContext(SSRContext);
  ...
  if (typeof window == 'undefined') {
    ...
    var stores = window[urqlTransportSymbol] || [];
